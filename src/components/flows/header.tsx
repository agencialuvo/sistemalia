    ...
    <div className="flex flex-col gap-1.5 px-6 pt-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <input
          ...
          spellCheck={false}
          aria-label={t("header.namePlaceholder")}
        ...
        {dirty && (
          <span
            ...
            title={t("header.unsavedChangesHint")}
            aria-live="polite"
          >
      ...
      <input
        ...
        aria-label={t("header.descriptionAriaLabel")}
